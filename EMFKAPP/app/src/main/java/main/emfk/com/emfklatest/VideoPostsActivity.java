...
public class VideoPostsActivity extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populatePostsData();
        pAdapter = new PostsAdapter(postsList, getApplicationContext(), FTS_VIDEOS_TABLE);
