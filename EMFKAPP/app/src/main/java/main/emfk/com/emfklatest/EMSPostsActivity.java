...
public class EMSPostsActivity extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ems_posts);
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_layout_ems);
    ...
    private void populatePostsData(){
        ...
        if (cursor.moveToFirst()) {
            ...
            try {
                ...
                pAdapter = new PostsAdapter(postsList, getApplicationContext(), FTS_EMS_TABLE);
